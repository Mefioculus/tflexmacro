...
namespace PDM_Changing
{
    public class Macro : MacroProvider
    {
        ...
        private static string _папкаАрхив = "Архив МО";
        ...
        private void CopyFilesForChanging(ReferenceObject linkedReferenceObject, ReferenceObject changing, TFlex.DOCs.Model.References.Files.FolderObject folderForChangingFiles)
        {
            ...
            List<FileObject> originalFiles = originalDocument.GetFiles().Where(file => file.Path.ToString().ToLower().Contains(_папкаАрхив.ToLower()+@"\оригиналы")).ToList();
        ...
        public void ПринятьНаХранение(ReferenceObject currentObj)
        {
